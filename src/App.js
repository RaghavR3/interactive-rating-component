...
function App() {
  ...
  return submitted == 0 ? (
    <div className="bg-primary-dark h-[100vh] w-[100vw] flex flex-row justify-center items-center">
      <div className="bg-primary-blue flex flex-col p-10 rounded-2xl">
        <div className="w-10 h-10 rounded-full bg-secondary-blue flex flex-col justify-center items-center mb-8">
        ...
        <h2 className="font-bold text-white text-3xl mb-2">How did we do?</h2>
        <p className="text-paragraph w-72 lg:w-96 pb-6">
          Please let us know how we did with your support request. All feedback
          is appreciated to help us improve our offering!
        </p>
        <Rating functions={[rating, setRating]}></Rating>
        <button
          onClick={() => setSubmitted(true)}
          className="bg-orange mt-8 py-3 rounded-full text-white font-bold tracking-widest hover:bg-white hover:text-orange"
        >
          SUBMIT
        </button>
      </div>
    ...
    <div className="bg-primary-dark h-[100vh] w-[100vw] flex flex-row justify-center items-center">
      <div className="bg-primary-blue flex flex-col p-10 rounded-2xl justify-center items-center">
        ...
        <div className="bg-secondary-blue text-orange pt-3 pb-2 px-5 rounded-full mt-8">
          You selected {rating} out of 5
        </div>
        <h2 className="text-white font-bold text-2xl pt-8">Thank you!</h2>
        <p className="text-paragraph pt-2 w-72 lg:w-96 text-center">
